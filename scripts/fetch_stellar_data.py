...
STELLAR_SCALE_DEFAULT = 10 ** 5

# All 9 Spiko Stellar tokens are Stellar Asset Contracts (SAC) with 5 decimal
# places (confirmed 2026-05-10 via Soroban RPC getLedgerEntries).
STELLAR_SCALES = {}
